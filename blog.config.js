...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'd69304e42a194374867205916584f4b9,output:c159dcd7d60b40cba9c898d4d3ed473a',
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '人類圖, Notion, 萬萬, 人類設計, 內在系統 ', // 网站关键词 英文逗号隔开
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '光之伊甸', // 备案号 闽ICP备XXXXXXX
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,facebook,line,email,messenger,telegram,twitter,reddit,whatsapp,wechat,qq,weibo,linkedin', // 分享的服務，按顺序显示,逗号隔开
  ...
  COMMENT_VALINE_PLACEHOLDER:
    process.env.NEXT_PUBLIC_VALINE_PLACEHOLDER || '沙發是空的唷～搶一下阿～', // 可以搭配后台管理评论 https://github.com/DesertsP/Valine-Admin  便于查看评论，以及邮件通知，垃圾评论过滤等功能
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '萬事歸一', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
