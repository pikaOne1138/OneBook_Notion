...
const BLOG = {
  ...
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '萬萬, 人類圖, Notion, 人類設計, 內在系統 ', // 网站关键词 英文逗号隔开
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,facebook,line,email,messenger,telegram,twitter,reddit,whatsapp,wechat,linkedin', // 分享的服務，按顺序显示,逗号隔开
